...
import { PolicyAmendmentsComponent } from './policy-amendments.component';
...
describe('PolicyAmendmentsComponent', () => {
  ...
  it('should create the Policy Amendments component instance', () => {
    const fixture = TestBed.createComponent(PolicyAmendmentsComponent);
